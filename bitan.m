function [delta_V,delta_T] = bitan(a1,e1,a2,e2,delta_omega,mu)
...
info = msgbox('Inserisci a per  apocentro, p per pericentro');
where = inputdlg('Dove vuoi effettuare la manovra ?');
